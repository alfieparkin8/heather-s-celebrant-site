...
const Process = () => {
  ...
  return <section id="process" className="py-20 px-6 relative overflow-hidden">
      <div className="container mx-auto">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          {/* Steps */}
          {steps.map((step, index) => <div key={step.number} className={`relative flex items-start gap-6 md:gap-12 mb-12 last:mb-0 animate-fade-in-up ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`} style={{
